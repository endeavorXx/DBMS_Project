...
# Form implementation generated from reading ui file 'c:\Users\Asus\Desktop\DBMS Project\Ui_Files\admin_supply.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Supply_Id *"))
        self.label_3.setText(_translate("MainWindow", "Vendor_Id *"))
        self.label_4.setText(_translate("MainWindow", "Product_Id *"))
        self.label_6.setText(_translate("MainWindow", "Qty_supplied *"))
        self.label_8.setText(_translate("MainWindow", "Date"))
        self.label_7.setText(_translate("MainWindow", "Time"))
        self.label_5.setText(_translate("MainWindow", "Cost_per_piece *"))
        self.label_9.setText(_translate("MainWindow", "Total_cost"))
        self.label.setText(_translate("MainWindow", "Margin_percentage *"))
        self.addButton.setText(_translate("MainWindow", "Add"))
        self.updateButton.setText(_translate("MainWindow", "Delete"))
        self.selectButton.setText(_translate("MainWindow", "Select"))
        self.searchButton.setText(_translate("MainWindow", "Search"))
        self.clearButton.setText(_translate("MainWindow", "Clear"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Supply_ID"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Vendor_ID"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Product_ID"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Qty_Supplied"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Date"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Time"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "Cost_per_piece"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "Total_Cost"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "Margin_Percentage"))
